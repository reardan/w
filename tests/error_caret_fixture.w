...
# too; the compile then continues to the ')' error, so a broken
# position restore in the context reader (compiler/tokenizer.w's
...
# expect_stderr: 	           ^
# expect_stderr: ')' expected, found '2'
# expect_stderr: 	return caret_error_probe("héllo" 2)
# expect_stderr: 	                                 ^
# reject_stderr: 	                                  ^
import lib.lib
...
int caret_error_probe(string s):
	return 0


int main():
	return caret_error_probe("héllo" 2)
