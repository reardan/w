# Mixed-size alloc/free churn regression benchmark for the free-list
# backend, lib/memory_freelist.w (dispatched to from lib/memory.w).
#
...
#
# The assertions use malloc_scan_steps (lib/memory_freelist.w), which
# counts free blocks examined by malloc — a deterministic scan-cost proxy that does
