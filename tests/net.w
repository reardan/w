...
int main(int argc, int argv):
	...
	asserts(c"Could not open socket", file >= 0)
	char* msg = c"yo yo yo!\x0a"
	int send_result = socket_send_to_ipv4(file, msg, strlen(msg), 0, ip4_from_string(c"127.0.0.1"), 9)
	print_int(c"send_result: ", send_result)
