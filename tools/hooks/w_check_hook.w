...
int main(int argc, int argv):
	...
	string_append(message, c"\nFix warnings as well as errors: the self-host build stages compile with --strict, so stray warnings fail './wbuild build'. Re-run './bin/wv2 check --json <file>' after fixing.")
