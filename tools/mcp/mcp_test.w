...
int main(int argc, int argv):
	...
	json_value* target3 = json_array_get(targets, 3)
	json_value* target4 = json_array_get(targets, 4)
	json_value* target5 = json_array_get(targets, 5)
	assert_strings_equal(c"json_test", target0.string_value)
	assert_strings_equal(c"json_64_test", target1.string_value)
	assert_strings_equal(c"json_codec_test", target2.string_value)
	assert_strings_equal(c"json_codec_64_test", target3.string_value)
	assert_strings_equal(c"json_rpc_test", target4.string_value)
	assert_strings_equal(c"json_rpc_64_test", target5.string_value)
	json_free(changed)
