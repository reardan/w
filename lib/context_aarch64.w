# AArch64 register context shared by the arm64 and arm64_darwin targets:
# layout matches the get_context/store_context stubs in
# code_generator/arm64_asm.w, which store x0..x30 into 31 word-sized
# slots. The context capture is ISA-level, not OS-level.
