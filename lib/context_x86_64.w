# x86-64 register context shared by the x64 and win64 targets: layout
# must match the get_context/store_context stubs in
# code_generator/x64_asm.w (sixteen 8-byte slots, int is word-sized on
# x86-64). define_asm_functions_x64_portable emits those stubs for both
# the Linux and the Windows target, so one layout serves both.
