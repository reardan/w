...
# 9 arguments: the ninth spills past x0..x7 into the single
# integer-class stack slot the arm64_darwin FFI shim supports
# (code_generator/ffi.w, emit_c_abi_call_arm64).
