...
# Pops the oldest event from the host-side queue into five int32s
# (kind, code, x, y, mods — the gfx_event_kind and gfx_mod numbers from
# graphics.event, mirrored in tools/web/index.html); returns 0 when the
