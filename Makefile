...
wtest_map_test: wtest FORCE
	...
	diff -u ./bin/wtest_map.expected ./bin/wtest_map.out
	./bin/wtest changed libs/standard/net/ipaddress.w > ./bin/wtest_map.out
	printf 'standard_net_web_test\n' > ./bin/wtest_map.expected
	diff -u ./bin/wtest_map.expected ./bin/wtest_map.out
...
standard_net_web_test: w FORCE
	./bin/wv2 libs/standard/net/net_web_test.w -o ./bin/standard_net_web_test
	./bin/standard_net_web_test
