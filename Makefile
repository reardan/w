...
wtest_map_test: wtest FORCE
	...
	printf 'file_test\n' > ./bin/wtest_map.expected
	diff -u ./bin/wtest_map.expected ./bin/wtest_map.out
	./bin/wtest changed libs/standard/time/calendar.w > ./bin/wtest_map.out
	printf 'standard_time_test\n' > ./bin/wtest_map.expected
	diff -u ./bin/wtest_map.expected ./bin/wtest_map.out
...
standard_time_test: w FORCE
	./bin/wv2 libs/standard/time/time_test.w -o ./bin/standard_time_test
	./bin/standard_time_test
