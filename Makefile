...
standard_formats_csv_test: w FORCE
	./bin/wv2 libs/standard/formats/csv_test.w -o ./bin/standard_formats_csv_test
	./bin/standard_formats_csv_test

standard_formats_configparser_test: w FORCE
	./bin/wv2 libs/standard/formats/configparser_test.w -o ./bin/standard_formats_configparser_test
	./bin/standard_formats_configparser_test
