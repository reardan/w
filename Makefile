...
c_import_preprocess_test: w FORCE
	./bin/wv2 tests/c_import_preprocess_test.w >./bin/c_import_preprocess_test
	chmod +x ./bin/c_import_preprocess_test
	./bin/c_import_preprocess_test
...
tests: build verify lib_test path_test grammar_test list_test type_table_test bignum_test float_literal_test float_test float_reference_test array_slice_string_test bounds_trap_test range_bounds_trap_test buffer_field_assign_test warning_test int64_x86_error_test struct_test struct_method_test pointer_test range_test type_system_p0_test type_system_error_test type_system_warning_test for_test for_container_test import_test c_import_preprocess_test c_import_test directory_test multilayer_test threading_test hash_map_test string_test array_list_test json_test parser_generator_test parser_generator_w_test parser_generator_c_test linked_list_test format_test time_test args_test result_test net_test net_basic debug_test repl_test dynamic_test test hello tests_x64 FORCE
