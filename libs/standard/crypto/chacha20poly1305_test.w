...
void test_rfc8439_seal_282():
	char* key = hex_bytes(c"808182838485868788898a8b8c8d8e8f909192939495969798999a9b9c9d9e9f")
	char* nonce = hex_bytes(c"070000004041424344454647")
	char* aad = hex_bytes(c"50515253c0c1c2c3c4c5c6c7")
...
void test_rfc8439_open_a5():
	char* key = hex_bytes(c"1c9240a5eb55d38af333888604f6b5f0473917c1402b80099dca5cbc207075c0")
	char* nonce = hex_bytes(c"000000000102030405060708")
	char* aad = hex_bytes(c"f33388860000000000004e91")
	char* ct = hex_bytes(c"")
...
void test_open_fail_closed():
	...
	char* nonce = hex_bytes(c"070000004041424344454647")
	char* aad = hex_bytes(c"50515253c0c1c2c3c4c5c6c7")
	char* ct = hex_bytes(c"d31a8d34648e60db7b86afbc53ef7ec2a4aded51296e08fea9e2b5a736ee62d63dbea45e8ca9671282fafb69da92728b1a71de0a9e060b2905d6a5b67ecd3b3692ddbd7f2d778b8c9803aee328091b58fab324e4fad675945585808b4831d7bc3ff4def08e4b7a9de576d26586cec64b6116")
	char* tag = hex_bytes(c"1ae10b594f09e26a7e902ecbd0600691")
	int aad_len = strlen(c"50515253c0c1c2c3c4c5c6c7") / 2
...
void test_wycheproof_vectors():
	...
	for wp_aead* v in vectors:
		char* key = hex_bytes(v.key)
		char* nonce = hex_bytes(v.nonce)
		char* aad = hex_bytes(v.aad)
		char* msg = hex_bytes(v.msg)
		char* ct = hex_bytes(v.ct)
		char* tag = hex_bytes(v.tag)
